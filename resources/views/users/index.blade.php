<x-users.layouts.master>
    ...
    <div class="banner-carousel banner-carousel-1 mb-0">
        <div class="banner-carousel-item" style="
                        background-image: url(user/images/slider-main/bg1.jpg);
                    ">
        ...
        <div class="banner-carousel-item" style="
                        background-image: url(user/images/slider-main/bg2.png);
                    ">
                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-md-12">
                            ...
                            <p data-animation-in="slideInRight">
                                <a href="#" class="slider btn btn-primary border"> Live Practice</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="banner-carousel-item" style="
                        background-image: url(user/images/slider-main/bg3.jpg);
                    ">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-12">
                    ...
                    <h3 class="section-sub-title">Know About Cyber Security</h3>
                </div>
            </div>
            <!--/ Title row end -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h2 class="service-box-title">Most Common Question</h2>
                    <br>

                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="user/images/icon-image/service-icon1.png" alt="service-icon" />
                        </div>
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="user/images/icon-image/service-icon3.png" alt="service-icon" />
                        </div>
                        <div class="ts-service-box-info">
                            <h3 class="service-box-title">
                ...
                <div class="col-lg-6 mt-6 mt-lg-0 mb-4 mb-lg-0">
                    <h2 class="service-box-title">Blog</h2>
                    <br>

                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="user/images/icon-image/service-icon4.png" alt="service-icon" />
                        </div>
                        <div class="ts-service-box-info">
                            <h3 class="service-box-title">
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="user/images/icon-image/service-icon5.png" alt="service-icon" />
                        </div>
                        <div class="ts-service-box-info">
                            <h3 class="service-box-title">
                                <a href="#">Renovation</a>
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="user/images/icon-image/service-icon6.png" alt="service-icon" />
                        </div>
                        <div class="ts-service-box-info">
                            <h3 class="service-box-title">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-12">
                    ...
                    <h3 class="section-sub-title">Latest</h3>
                </div>
            </div>
            <!--/ Title row end -->
            ...
            <div class="row">
                    ...
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="news-single.html" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="user/images/news/news1.jpg" alt="img" />
                            </a>
                        </div>
                        <div class="post-body">
                            <h4 class="post-title">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="news-single.html" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="user/images/news/news2.jpg" alt="img" />
                            </a>
                        </div>
                        <div class="post-body">
                            <h4 class="post-title">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="news-single.html" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="user/images/news/news3.jpg" alt="img" />
                            </a>
                        </div>
                        <div class="post-body">
                            <h4 class="post-title">
                    ...
                    <div id="testimonial-slide" class="testimonial-slide">
                        <div class="item">
                            <div class="quote-item">
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb" src="user/images/clients/testimonial1.png" alt="testimonial" />
                        ...
                        <div class="item">
                            <div class="quote-item">
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb" src="user/images/clients/testimonial2.png" alt="testimonial" />
                                    <div class="quote-item-info">
                                        <h3 class="quote-author">
                                            Weldon Cash
                                        </h3>
                        ...
                        <div class="item">
                            <div class="quote-item">
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb" src="user/images/clients/testimonial3.png" alt="testimonial" />
                                    <div class="quote-item-info">
                                        <h3 class="quote-author">
                                            Minter Puchan
                                        </h3>
                    ...
                    <div class="row all-clients">
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="user/images/clients/client1.png" alt="clients-logo" /></a>
                            </figure>
                        </div>
                        <!-- Client 1 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="user/images/clients/client2.png" alt="clients-logo" /></a>
                            </figure>
                        </div>
                        <!-- Client 2 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="user/images/clients/client3.png" alt="clients-logo" /></a>
                            </figure>
                        </div>
                        <!-- Client 3 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="user/images/clients/client4.png" alt="clients-logo" /></a>
                            </figure>
                        </div>
                        <!-- Client 4 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="user/images/clients/client5.png" alt="clients-logo" /></a>
                            </figure>
                        </div>
                        <!-- Client 5 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="user/images/clients/client6.png" alt="clients-logo" /></a>
                            </figure>
                        </div>
                        <!-- Client 6 end -->
                    </div>
  ...
  ================================================== -->
    ...
    <!-- Bootstrap jQuery -->
    <script src="user/plugins/bootstrap/bootstrap.min.js" defer></script>
    <!-- Slick Carousel -->
    <script src="user/plugins/slick/slick.min.js"></script>
    <script src="user/plugins/slick/slick-animation.min.js"></script>
    <!-- Color box -->
    <script src="user/plugins/colorbox/jquery.colorbox.js"></script>
    <!-- shuffle -->
