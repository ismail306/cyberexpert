                            ...
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted"><a href="#">jlrdw</a> replied <span class="text-secondary font-weight-bold">3 hours ago</span></p>
                                    </div>
                            ...
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted"><a href="#">ciungulete</a> replied <span class="text-secondary font-weight-bold">7 hours ago</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
                            ...
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted"><a href="#">bugsysha</a> replied <span class="text-secondary font-weight-bold">11 hours ago</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
                            ...
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted"><a href="#">jackalds</a> replied <span class="text-secondary font-weight-bold">12 hours ago</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
                            ...
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted"><a href="#">bugsysha</a> replied <span class="text-secondary font-weight-bold">14 hours ago</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
                            ...
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted"><a href="#">michaeloravec</a> replied <span class="text-secondary font-weight-bold">18 hours ago</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
