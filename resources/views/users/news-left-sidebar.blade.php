                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="post-info">
                                        <h4 class="entry-title">
                                            <a href="#">We Just Completes $17.6
                                                Million Medical Clinic
                                                In Mid-missouri</a>
                                        </h4>
                                    </div>
                                </li>
                            ...
                            <div class="entry-header">
                                <div class="post-meta">
                                    ...
                                    <span class="post-comment"><i class="far fa-comment"></i>
                                        03<a href="#" class="comments-link">Comments</a></span>
                                </div>
                                <h2 class="entry-title">
                                    <a href="news-single.html">We Just Completes $17.6 million
                                        Medical Clinic in
                                        Mid-Missouri</a>
                                </h2>
                            </div>
                    ...
                    <div class="post">
                        ...
                        <div class="post-body">
                            <div class="entry-header">
                                ...
                                <h2 class="entry-title">
                                    <a href="news-single.html">Thandler Airport Water
                    ...
                    <div class="post">
                        ...
                        <div class="post-body">
                            <div class="entry-header">
                                ...
                                <h2 class="entry-title">
                                    <a href="news-single.html">Silicon Bench and Cornike Begin
